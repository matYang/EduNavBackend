...
public class ModelDataLoaderService {	
	...
	private static void loadCourses(Connection...connections){		
		...
		teacherImgs.add("杨雪，女，基础部专任礼仪教师。1994年毕业于四川师范学院中文系，获汉语言文学学士学位。2007年毕业于中国人民大学国际关系学院，主修外交学，获法学硕士学位。现主要担任职业礼仪训练、社交礼仪教学和公务员政务礼仪培训工作。");
		teacherImgs.add("徐梦真，女，已考取普通话一级乙等证书、大学英语六级证书、秘书资格证书（高级）等证书。本科毕业于四川师范大学文学院汉语言文学专业，主要学习中国古代文学、现当代文学、外国文学等多门专业课程；研究生毕业于四川师范大学文学院比较文学与世界文学，师从董志强教授，" +
				"主攻比较诗学方向，多次荣获学校表彰奖励，获文学硕士学位。在校期间成绩优秀，多次荣获学校奖学金并公开发表论文。 现就职于四川财经职业学院基础部，主要承担应用文写作、" +
				"公关关系学、商务秘书写作（认证）、演讲与口才等课程的教学任务，不断钻研科学育人的方法，探索教学规律，把握课前、课中、课后三环节，注意调动学生的积极性，做到教学“六认真”，" +
				"工作积极负责，荣获二〇〇九年度先进个人、二〇一〇年度青年教师评教活动优秀、二〇〇九学年度“优秀共产党员”等称号。 在职期间科研成果：" +
				"《柏拉图妇女思想探讨》，重庆科技学院学报，2009-12。参与“国家财政干部公文写作”。");
		teacherImgs.add("罗吉宏，男，1979年2月出生于四川渠县，中共党员，研究生学历。曾就读于四川渠县师范学校、四川师范大学、四川大学，先后获取中等师范文凭、汉语言文学专科和本科文凭、英语本科文凭、汉语言文字学研究生文凭和硕士学位。在各级各类报刊发表散文、诗歌近30篇/首,县作协会员；在省级刊物公开发表学术论文5篇；曾参与四川省重点文化建设项目——《四川省志·方言志·湘方言篇》之湘方言调查，先后调查了金堂竹篙方言、乐至靖州腔、仪陇新城方言，并整理了竹篙方言声韵调系统。1999年走上教育工作岗位，先后在四川渠县和乐学校、四川渠县天星初级中学、川师附中从事过初中英语和语文教学工作；2010年7月至今在四川财经职业学院基础部从事《应用文写作》和《中国传统文化》教学工作。");
