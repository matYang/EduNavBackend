...
public class ModelDataLoaderService {	
	...
	private static void loadBookings(Connection...connections) 
			throws CourseNotFoundException, UserNotFoundException, PartnerNotFoundException{
	...
	private static void loadUsers(Connection...connections) throws ValidationException{
		String name = "Harry";
	...
	private static void loadPartners(Connection...connections) throws ValidationException{
		String name = "XDF";
	...
	private static void loadTransactions(Connection...connections) 
		...
		user = UserDao.getUserById(2,connections);
		booking = BookingDao.getBookingById(2,connections);		
		amount = 20;
