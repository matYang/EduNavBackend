...
public class AlipayConfig {
	 ...
	 private static AlipayConfig  alconfig = null;
	    ...
	    // 签约支付宝账号或卖家收款支付宝帐户
	    public static String seller_email = "admin@ishangke.cn";
	    // 读配置文件

	    // notify_url 交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
	     public static String notify_url ="http://www.ishangke.cn/api/v1.0/alipay/alipay_notifyUrl";


	    // 付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
	    // return_url的域名不能写成http://localhost/js_jsp_utf8/return_url.jsp，否则会导致return_url执行无效
	    public static String return_url = "http://www.ishangke.cn/api/v1.0/alipay/alipay_returnUrl";
		...
		public static String log_path = "log4j";
		
		public static String paymethod = "directPay";
		
		public static String successRedirect = "http://www.ishangke.cn";
		public static String failureRedirect = "http://partner.ishangke.cn";
}
