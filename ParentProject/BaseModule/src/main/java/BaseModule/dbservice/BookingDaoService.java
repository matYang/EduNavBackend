...
public class BookingDaoService {
	...
	public static void updateBookingStatuses(Booking curBooking, BookingStatusObj statusObj, final int adminId, Connection...connections) throws PseudoException, SQLException{
		...
		try{
			...
			if (statusObj.bookingStatus != null && statusObj.bookingStatus != curBooking.getStatus()){
				...
				if (!ValidStateTransferService.validateBookingStatusTransfer(curBooking.getStatus(), statusObj.bookingStatus)){
			...
			if (statusObj.serviceFeeStatus != null && statusObj.serviceFeeStatus != curBooking.getServiceFeeStatus()){
				if (!ValidStateTransferService.validateServiceFeeStatusTransfer(curBooking.getServiceFeeStatus(), statusObj.serviceFeeStatus)){
			...
			if (statusObj.commissionStatus != null && statusObj.commissionStatus != curBooking.getCommissionStatus()){
				if (!ValidStateTransferService.validateCommissionStatusTransfer(curBooking.getCommissionStatus(), statusObj.commissionStatus)){
