		...
		static{
			try{
				...
				if (value == null || (!value.equals(ENV_TEST) && !value.equals(ENV_PROD))){
					...
					configurationMap.put("jdbcUri", "114.215.181.254:3306/db19r3708gdzx5d1?allowMultiQueries=true&&characterSetResults=UTF-8&characterEncoding=UTF-8&useUnicode=yes");
