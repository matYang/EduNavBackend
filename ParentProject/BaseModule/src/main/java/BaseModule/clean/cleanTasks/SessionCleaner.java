	...
	public static void clean() {		
		...
		try{
			...
			for(String key : keys){
				...
				long timeStamp = DateUtility.getLongFromTimeStamp(sessionString.split(RedisAuthenticationConfig.redisAuthenticationSeperatorRegex)[2]);			
			...
			for(String key : keys){
				String sessionString = redis.get(key);
				long timeStamp = DateUtility.getLongFromTimeStamp(sessionString.split(RedisAuthenticationConfig.redisAuthenticationSeperatorRegex)[1]);			
