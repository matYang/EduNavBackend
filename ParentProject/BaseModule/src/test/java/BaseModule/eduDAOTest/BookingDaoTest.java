...
public class BookingDaoTest {
	...
	public void testGet() throws CourseNotFoundException, ValidationException, BookingNotFoundException{
		...
		Booking booking2 = new Booking(timeStamp,course2.getStartTime(), course2.getFinishTime(), course2.getPrice(), userId, partnerId, course2Id, user.getName(), partner.getPhone(),partner.getReference(),status);
